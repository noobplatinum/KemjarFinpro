...
import { api, User, Middleman, MiddlemanLog, Card as CardType, InventoryItem, clearCsrfToken } from '@/lib/api';
...
export default function TransferPage() {
    ...
    const handleChangePassword = async (e: React.FormEvent) => {
        ...
        setIsLoading(true);
        try {
            await api.middleman.changePassword({
                                ...
                                <form onSubmit={handleChangePassword} className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) =>
                                                setChangePasswordData({ ...changePasswordData, current_password: e.target.value })
                                            }
                                    ...
                                    <Button
                                        type="submit"
                                        className="w-full"
                                        disabled={isLoading || !changePasswordData.current_password || !changePasswordData.new_password}
                                    >
